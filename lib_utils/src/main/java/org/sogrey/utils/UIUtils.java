...
public class UIUtils {
    ...
    private UIUtils(){}
    public UIUtils from(Context context) {
        this.mContext = context;
        return this;
    }
    private Context getContext(){
        if(this.mContext==null) throw new NullPointerException("The Context is Null,you must call from(Context) first.");
