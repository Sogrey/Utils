...
/**
 * 指纹识别 需要权限 &lt;uses-permission android:name="android.permission.USE_FINGERPRINT"/&gt; <br/>
    ...
    public boolean isFinger() {
        ...
        if (ActivityCompat.checkSelfPermission(mContext,Manifest.permission.USE_FINGERPRINT)
            ...
            if (mOnFingerprintAuthenticationListener!=null) {
                mOnFingerprintAuthenticationListener.post(OnFingerprintAuthenticationListener.FingerprintAuthentType
